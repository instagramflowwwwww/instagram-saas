    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="space-y-5">
        ...
        <section className="bg-[#111] border border-white/5 rounded-2xl p-6">
          ...
          <form onSubmit={saveApp} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  maxLength={50}
                  placeholder="Ex.: App Principal, App Clientes..."
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-medium text-gray-400 mb-1.5">Instagram App ID</label>
                <div className="relative">
              ...
              <div>
                <label className="block text-xs font-medium text-gray-400 mb-1.5">App Secret</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder={editingAppId ? "Deixe vazio para manter o secret atual" : "Instagram App Secret"}
                  ...
                  />
                  <button type="button" onClick={() => setShowSecret((c) => !c)} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-white">
            ...
            <div className="flex flex-wrap gap-3">
              <button type="submit" disabled={saving} className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white text-sm font-semibold px-5 py-3 rounded-xl hover:opacity-90 disabled:opacity-50">
                {saving ? <Loader2 size={15} className="animate-spin" /> : editingAppId ? <Save size={15} /> : <Plus size={15} />}
                {saving ? "Salvando..." : editingAppId ? "Salvar alterações" : "Adicionar app"}
              </button>
              {editingAppId && (
                <button type="button" onClick={resetForm} className="inline-flex items-center justify-center gap-2 bg-white/5 border border-white/10 text-gray-300 text-sm font-medium px-5 py-3 rounded-xl hover:bg-white/10">
                  <X size={15} /> Cancelar
                </button>
              )}
            </div>
                  ...
                  >
                    <div className="flex items-center gap-2 min-w-0">
                      ...
                      <div className="min-w-0">
                        <p className="text-xs font-semibold text-white truncate">{getAppLabel(app, index)}</p>
                        <p className="text-[10px] text-gray-500 font-mono truncate">
                          {maskAppId(app.appId)} · {app.accountsCount} conta{app.accountsCount === 1 ? "" : "s"}
                        </p>
                      </div>
                    </div>
        ...
        <section className="bg-[#111] border border-white/5 rounded-2xl p-6">
          ...
          <div className="mb-3">
            <h3 className="text-sm font-medium text-white">Contas do app selecionado</h3>
          </div>
          ...
          {selectedAccounts.length === 0 ? (
            <div className="border border-dashed border-white/10 rounded-xl py-9 text-center">
              ...
              <p className="text-gray-500 text-sm">Nenhuma conta conectada por este App Meta.</p>
            </div>
          ) : (
                ...
                <div key={account.id} className="flex items-center gap-3 bg-white/[0.025] border border-white/5 rounded-xl p-3.5">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-xs text-gray-500 truncate">
                      ...
                      {account.followerCount !== null ? ` · ${account.followerCount.toLocaleString("pt-BR")} seguidores` : ""}
                    </p>
                  ...
                  <span className={`hidden sm:inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[11px] ${
        ...
        <section className="bg-[#111] border border-white/5 rounded-2xl p-6">
          <div className="flex items-center justify-between gap-4 mb-5">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">Repita a configuração para cada App Meta cadastrado.</p>
            </div>
            <a href="https://developers.facebook.com/apps/" target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 text-xs text-purple-400 hover:text-purple-300">
              Abrir Meta Developers <ExternalLink size={12} />
            </a>
          </div>
